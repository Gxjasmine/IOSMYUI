...
//            [instructions addObject:videoInstruction];
            ...
            CustomVideoCompositionInstruction *videoInstruction2 = [[CustomVideoCompositionInstruction alloc] initWithSourceTrackIDs:@[[NSNumber numberWithInt:compositionVideoTracks[0].trackID], [NSNumber numberWithInt:compositionVideoTracks[1].trackID]] timeRange:passThroughTimeRanges[i]];
