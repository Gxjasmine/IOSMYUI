...
//    self.testImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 20, 300, 300)];
...
- (void)synchronizePlayerWithEditor
{
    ...
    self.imageGenerator = [AVAssetImageGenerator assetImageGeneratorWithAsset:[self.editor playerComposition]];
          self.imageGenerator.appliesPreferredTrackTransform = YES;
          self.imageGenerator.requestedTimeToleranceAfter =  kCMTimeZero;
          self.imageGenerator.requestedTimeToleranceBefore =  kCMTimeZero;

          self.imageGenerator.maximumSize = CGSizeMake(300, 300);
}
...
//
//                   [weakSelf.testImageView setImage:videoScreen];
//                });
